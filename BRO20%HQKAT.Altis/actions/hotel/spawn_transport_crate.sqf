...
#define CRATE_CLASSNAME "Box_NATO_AmmoVeh_F"
...
[_crate, 20000] call ace_rearm_fnc_setSupplyCount;

// Log the spawn. Just in case someone is trying to crash the server.
[[player, _spawn_pos], {
	diag_log Format["[BRO Spawners Transport]: %1 spawned %2 at position %3", name (_this select 0), CRATE_CLASSNAME, _this select 1];
