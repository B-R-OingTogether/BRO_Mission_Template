...
#define CRATE_CLASSNAME "B_Slingload_01_Fuel_F"
...
[_crate, 20000] call ace_refuel_fnc_setFuel;

// Log the spawn. Just in case someone is trying to crash the server.
[[player, _spawn_pos], {
	diag_log Format["[BRO Spawners FOB Fuel]: %1 spawned %2 at position %3", name (_this select 0), CRATE_CLASSNAME, _this select 1];
