...
#define CRATE_CLASSNAME "FlexibleTank_01_forest_F"
...
[[player, _spawn_pos], {
	diag_log Format["[BRO Spawners Flexi Fuel]: %1 spawned %2 at position %3", name (_this select 0), CRATE_CLASSNAME, _this select 1];
