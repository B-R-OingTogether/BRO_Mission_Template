...
#define CRATE_CLASSNAME "Box_East_AmmoVeh_F"
...
[[player, _spawn_pos], {
	diag_log Format["[BRO Spawners Ammo Rearm]: %1 spawned %2 at position %3", name (_this select 0), CRATE_CLASSNAME, _this select 1];
