...
#define CRATE_CLASSNAME "Land_PlasticCase_01_medium_olive_F"
...
[[player, _spawn_pos], {
	diag_log Format["[BRO Spawners GMG ammo]: %1 spawned %2 at position %3", name (_this select 0), CRATE_CLASSNAME, _this select 1];
