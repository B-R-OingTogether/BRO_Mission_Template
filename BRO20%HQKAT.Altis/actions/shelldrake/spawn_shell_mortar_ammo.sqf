...
#define CRATE_CLASSNAME "BOX_IED_Exp_f"
...
[[player, _spawn_pos], {
	...
	diag_log Format["[BRO Spawners Mortars ammo]: %1 spawned %2 at position %3", name (_this select 0), CRATE_CLASSNAME, _this select 1];
